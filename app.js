...
function readinessMarkup(){
  ...
  return `<section class="readinessScreen">
    ...
    <p class="readinessNote">Trip-specific packing guidance arrives in M3-04.2; weather-aware recommendations follow in M3-04.3.</p>
  </section>`;
}
...
${reservationMarkup(d)}
${smartStopsMarkup(d)}
<div class=reservationSummary><span><b>🍽️ Food plan</b><small>${d.food}</small></span><strong>›</strong></div>
