...
jobs:
  quality-checks:
    ...
    steps:
      ...
      - name: Run packing tests
        run: node packing.test.js
      ...
      - name: Verify M3-04.2 integrations
        shell: bash
        run: |
          grep -q 'data-day-weather' app.js
          grep -q 'loadTripForecast' app.js
          grep -q 'forecast_days:'16'' weather-service.js
          ! grep -q 'Live forecast coming in M3-03' app.js
          ! grep -q 'Weather connects in Milestone 3' app.js
          grep -q 'M3-04.2' app.js
          grep -q 'Kaseryn' packing.js
          grep -q 'Bubbe' packing.js
          grep -q 'Papa' packing.js
          echo "M3-04.2 integration checks passed."
