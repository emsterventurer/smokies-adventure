...
function readinessMarkup(){
  ...
  return `<section class="readinessScreen">
    ...
    <p class="readinessNote">Weather and activity-based packing guidance are intentionally reserved for M3-03.</p>
  </section>`;
}
