...
assert(app.includes('AdventureCompanionBuild'),'app must consume centralized build information');
assert(html.includes('src="version.js"'),'central version script missing from HTML');
